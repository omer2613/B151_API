    ...
    */
    ...
    public void get13() {
        ...
        String body=" {\n" +
                ...
                "                \"completed\": true\n" +
                "            }";
        HashMap expectedData=ObjectMapperUtils.convertJsonToJava(body, HashMap.class);//read value'yu kullanabilmek icin body yi bir String container a koyduk
        //convertJasonToJava() metodu static oldugu icin dogrudan yazabilirdik
        ...
        //String'i baska formata cevirmezdi
